                    ...
                    <div className="flex items-center justify-between px-4 mb-10">
                        <div className="space-y-1">
                            <h4 className="text-xs font-black text-zinc-900 dark:text-zinc-100 uppercase tracking-[0.3em] flex items-center gap-4">
                                <div className="p-2 bg-orange-600 rounded-xl text-white shadow-lg shadow-orange-500/30">
                        ...
                        {allCohorts.map((cohortName: string, i: number) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="flex flex-col bg-white dark:bg-zinc-950/40 border border-zinc-200 dark:border-zinc-800/60 rounded-[32px] p-8 hover:border-orange-500/50 dark:hover:border-orange-400/50 hover:shadow-2xl transition-all duration-500 group/cohort relative overflow-hidden"
                                >
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <ul className="space-y-3">
                                                {questions.slice(0, 3).map((q: string, idx: number) => (
                                                    <li key={idx} className="text-sm text-zinc-600 dark:text-zinc-400 pl-4 border-l-2 border-zinc-100 dark:border-zinc-800 font-medium group-hover/cohort:border-orange-500/30 transition-colors">
                                                        {q}
                                                    </li>
                                                ))}
                                                {questions.length > 3 && (
                                                    <li className="text-xs text-orange-500 font-bold pl-4 pt-1 flex items-center gap-2">
