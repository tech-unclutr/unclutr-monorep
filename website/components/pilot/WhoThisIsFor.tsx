...
export default function WhoThisIsFor() {
  ...
  useSectionVisibility("pilot_who", containerRef);

  return (
    <section ref={containerRef} data-section-name="pilot_who" id="who-this-is-for" className="py-12 sm:py-16 lg:py-20 bg-cream">
