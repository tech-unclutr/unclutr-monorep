...
const SAMPLE_REPORT_URL = "https://docs.google.com/document/d/1w5k0b3Xb_i2rc6U4gPdh13LZF36fM-wMmfjt5ZDbR1E/edit?usp=sharing";
...
export default function SampleBriefModal({ onClose }: { onClose: () => void }) {
  ...
  useEffect(() => {
    trackEvent(EventName.STUDY_MODAL_OPEN, { study_id: "sample_brief", source_section: "pilot" } as Record<string, string>);
    ...
    return () => {
      ...
      trackEvent(EventName.STUDY_MODAL_CLOSE, { study_id: "sample_brief", source_section: "pilot" } as Record<string, string>);
    };
  }, [onClose]);
