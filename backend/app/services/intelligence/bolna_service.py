...
class BolnaService:
    ...
    async def trigger_phone_call(
        ...
        # 2. Ensure E.164 format (default to +91 for India if missing and 10 digits)
        # This is a heuristic; ideally we strictly require E.164 from input
        if not clean_phone.startswith('+'):
            if len(clean_phone) == 10:
                ...
                clean_phone = f"+{clean_phone}"
                 ...
                 # Fallback for other lengths, assume it might be complete or needs another code
                 # But usually 10 digits = India in this context
                 clean_phone = f"+{clean_phone}"
