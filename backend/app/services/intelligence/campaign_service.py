    ...
    async def delete_campaign(self, session: AsyncSession, campaign_id: UUID, company_id: UUID) -> bool:
        ...
        try:
            ...
            archived_campaign = ArchivedCampaign(
                ...
                # source_file_hash=campaign.source_file_hash,
                # bolna_execution_id=campaign.bolna_execution_id,
                # bolna_agent_id=campaign.bolna_agent_id,
                # bolna_call_status=campaign.bolna_call_status,
                # bolna_conversation_time=campaign.bolna_conversation_time,
                # bolna_total_cost=campaign.bolna_total_cost,
                # bolna_error_message=campaign.bolna_error_message,
                # bolna_transcript=campaign.bolna_transcript,
                # bolna_extracted_data=campaign.bolna_extracted_data,
                # bolna_telephony_data=campaign.bolna_telephony_data,
