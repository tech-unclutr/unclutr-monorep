...
export function ShopifySuccessModal({ isOpen, onClose, shopName }: ShopifySuccessModalProps) {
                    ...
                    {isOpen && (
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                >
                                    <CheckCircle2 className="w-12 h-12 text-emerald-600 dark:text-emerald-500" strokeWidth={2} />
                            ...
                            >
                                ...
                                <p className="text-sm text-zinc-600 dark:text-zinc-400 max-w-xs mx-auto">
                                    {shopName ? (
                                        <>
                                            <span className="font-semibold text-emerald-600 dark:text-emerald-500">{shopName}</span>
                                            {" "}is now syncing with Unclutr. Initial data sync is in motion.
                                        </>
                                    ) : (
                                        "Your Shopify store is now syncing with Unclutr. Initial data sync is in motion."
                                    )}
                                </p>
                            </motion.div>
